    <table class="table" id="comments">
        ...
        <tr>
            ...
            <td>
                ...
                <p>{{$comment->comment}}</p>
                <small style="color: white">{{$comment->created_at}}</small>
            ...
            <td class="td-actions text-right">
                ...
                <a href="{{route('comment.delete',$comment->id)}}" rel="tooltip"  class="btn btn-white btn-link btn-sm" data-original-title="Remove Comment">
        ...
        <tr style="display: none" >
            <td colspan="4">
                <form action="{{ route('comment.update' ,  $comment->id) }}" method="post">
                    {{ csrf_field() }}
                    @include('back-end.comments.form' , ['users' => $comment ])
